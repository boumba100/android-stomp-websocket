package com.ama.nbouma.stompclient.implementation;


import com.ama.nbouma.stompclient.model.Frame;
import com.ama.nbouma.stompclient.services.StompClientProvider;
...
public abstract class StompClient implements StompClientProvider {
    ...
    protected abstract void onStompMessage(final Frame frame, final String message);
    ...
    public void disconnect() {
        ...
        onDisconnection("Device disconnected to server");
    }
    ...
    private void transmitFrame(final Frame frame) {
        if (this.webSocketClient != null && this.isWebSocketConnected) {
            ...
            onStompError("Device not connected to server");
        }
    }
        ...
        try {
            ...
            this.webSocketClient = new WebSocketClient(destinationURI, draft) {
                ...
                public void onMessage(String message) {
                    ...
                    onStompMessage(frame, frame.getBody());
                }
